...
text1[0].innerText="Hello everyone, how are you";
...
btn.addEventListener('click',function(){
   ...
   btn.style.border="2px solid marron";
...
const ele=document.getElementById('button-1');

ele.addEventListener('click',function(){
   elem.innerText="Welcome to my home";
